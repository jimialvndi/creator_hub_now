    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <aside class="w-64 bg-white border-r border-gray-200 hidden md:flex flex-col">
            <div class="h-16 flex items-center px-6 border-b border-gray-200">
                <span class="text-xl font-bold text-primary">UNTAN creat<span class="text-accent">*</span>r.</span>
            </div>
            ...
            <nav class="flex-1 overflow-y-auto py-4">
                <ul class="space-y-1 px-3">
                    ...
                    <li>
                        <a href="#" class="flex items-center px-3 py-2.5 rounded-lg transition group text-gray-700 hover:bg-blue-50 hover:text-primary">
                            <svg class="w-5 h-5 mr-3 text-gray-400 group-hover:text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"></path></svg>
                            Kelas Online <span class="ml-auto text-[10px] bg-gray-200 px-2 py-0.5 rounded-full">Soon</span>
                        </a>
                    </li>
